...
| M2 必验的第二台机器与第一版性能参考 | Y9000P，i7-12700H、RTX 3070 Ti Laptop、32 GB 内存 | 用户指定纳入 M2；配置由用户提供，尚未在该机器运行 |
...
当前 M2-A 已交付桌面候选版和局部验证报告，待用户人工验收，范围和进展见 [M2-A 桌面阶段报告](milestones/m2-a/README.md)。M2 整体通过、人工 15 分钟游玩通过、性能基线建立和笔记本通过均须有各自记录，不能由已完成的代码修改或自动测试推导。
